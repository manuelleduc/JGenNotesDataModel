...
import eu.jgen.notes.dm.ide.contentassist.antlr.PartialDataModelContentAssistParser;
import eu.jgen.notes.dm.ide.contentassist.antlr.internal.InternalDataModelLexer;
import eu.jgen.notes.dm.ui.contentassist.DataModelProposalProvider;
import eu.jgen.notes.dm.ui.labeling.DataModelDescriptionLabelProvider;
import eu.jgen.notes.dm.ui.labeling.DataModelLabelProvider;
import eu.jgen.notes.dm.ui.outline.DataModelOutlineTreeProvider;
import eu.jgen.notes.dm.ui.quickfix.DataModelQuickfixProvider;
...
/**
 * Manual modifications go to {@link DataModelUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractDataModelUiModule extends DefaultXbaseWithAnnotationsUiModule {
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(eu.jgen.notes.dm.parser.antlr.internal.InternalDataModelLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalDataModelLexer.class).toProvider(LexerProvider.create(InternalDataModelLexer.class));
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("DataModel Compare");
	}

...
public class DataModelSyntacticSequencer extends AbstractSyntacticSequencer {

	protected DataModelGrammarAccess grammarAccess;
	protected AbstractElementAlias match_Attribute_SemicolonKeyword_5_q;
	protected AbstractElementAlias match_Identifier_SemicolonKeyword_6_q;
	protected AbstractElementAlias match_Relationship_SemicolonKeyword_6_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (DataModelGrammarAccess) access;
		match_Attribute_SemicolonKeyword_5_q = new TokenAlias(false, true, grammarAccess.getAttributeAccess().getSemicolonKeyword_5());
		match_Identifier_SemicolonKeyword_6_q = new TokenAlias(false, true, grammarAccess.getIdentifierAccess().getSemicolonKeyword_6());
		match_Relationship_SemicolonKeyword_6_q = new TokenAlias(false, true, grammarAccess.getRelationshipAccess().getSemicolonKeyword_6());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_Attribute_SemicolonKeyword_5_q.equals(syntax))
				emit_Attribute_SemicolonKeyword_5_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_Identifier_SemicolonKeyword_6_q.equals(syntax))
				emit_Identifier_SemicolonKeyword_6_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_Relationship_SemicolonKeyword_6_q.equals(syntax))
				emit_Relationship_SemicolonKeyword_6_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_Attribute_SemicolonKeyword_5_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     features+=[EntityFeature|ID] ')' (ambiguity) (rule end)
	 */
	protected void emit_Identifier_SemicolonKeyword_6_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     relname=[Relationship|QualifiedName] (ambiguity) (rule end)
	 */
	protected void emit_Relationship_SemicolonKeyword_6_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}

 ...
 */
package eu.jgen.notes.dm.ide.contentassist.antlr;

import com.google.inject.Inject;
import eu.jgen.notes.dm.ide.contentassist.antlr.internal.InternalDataModelParser;
...
public class DataModelParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalDataModelParser createParser() {
		InternalDataModelParser result = new InternalDataModelParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getSubjectAreaFeatureAccess().getAlternatives(), "rule__SubjectAreaFeature__Alternatives");
					put(grammarAccess.getEntityFeatureAccess().getAlternatives(), "rule__EntityFeature__Alternatives");
					put(grammarAccess.getRelationshipAccess().getTypeAlternatives_2_0(), "rule__Relationship__TypeAlternatives_2_0");
					put(grammarAccess.getIdComponentAccess().getFeatureAlternatives_1_0(), "rule__IdComponent__FeatureAlternatives_1_0");
					...
					put(grammarAccess.getSubjectAreaAccess().getGroup(), "rule__SubjectArea__Group__0");
					put(grammarAccess.getWorksetAccess().getGroup(), "rule__Workset__Group__0");
					put(grammarAccess.getAttributeAccess().getGroup(), "rule__Attribute__Group__0");
					put(grammarAccess.getEntityAccess().getGroup(), "rule__Entity__Group__0");
					put(grammarAccess.getRelationshipAccess().getGroup(), "rule__Relationship__Group__0");
					put(grammarAccess.getIdComponentAccess().getGroup(), "rule__IdComponent__Group__0");
					put(grammarAccess.getIdentifierAccess().getGroup(), "rule__Identifier__Group__0");
					put(grammarAccess.getIdentifierAccess().getGroup_4(), "rule__Identifier__Group_4__0");
					...
					put(grammarAccess.getDataModelAccess().getAnnotationsAssignment_0(), "rule__DataModel__AnnotationsAssignment_0");
					put(grammarAccess.getDataModelAccess().getImportSectionAssignment_1(), "rule__DataModel__ImportSectionAssignment_1");
					put(grammarAccess.getDataModelAccess().getElementAssignment_2(), "rule__DataModel__ElementAssignment_2");
					put(grammarAccess.getSubjectAreaAccess().getNameAssignment_2(), "rule__SubjectArea__NameAssignment_2");
					put(grammarAccess.getSubjectAreaAccess().getElementsAssignment_4(), "rule__SubjectArea__ElementsAssignment_4");
					put(grammarAccess.getWorksetAccess().getNameAssignment_1(), "rule__Workset__NameAssignment_1");
					put(grammarAccess.getWorksetAccess().getElementsAssignment_3(), "rule__Workset__ElementsAssignment_3");
					...
					put(grammarAccess.getEntityAccess().getElementsAssignment_3(), "rule__Entity__ElementsAssignment_3");
					...
					put(grammarAccess.getRelationshipAccess().getRelnameAssignment_5(), "rule__Relationship__RelnameAssignment_5");
					put(grammarAccess.getIdComponentAccess().getFeatureAssignment_1(), "rule__IdComponent__FeatureAssignment_1");
					put(grammarAccess.getIdentifierAccess().getNameAssignment_1(), "rule__Identifier__NameAssignment_1");
					put(grammarAccess.getIdentifierAccess().getFeaturesAssignment_3(), "rule__Identifier__FeaturesAssignment_3");
					put(grammarAccess.getIdentifierAccess().getFeaturesAssignment_4_1(), "rule__Identifier__FeaturesAssignment_4_1");
